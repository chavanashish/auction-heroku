...
def model_form_upload(request):
    if request.method == 'POST':
        ...
        form = DocumentForm()
    return render(request, 'productprofile/profile.html', {
        'form': form
    })
'''
def profile(request):
...
def getproduct(request,id):
    ...
    return render(request,'productpage/productinfo.html',context,RequestContext(request))
...
def model_form_upload(request):
    if request.method == 'POST':
        ...
        form = DocumentForm()
    return render(request, 'productpage/profile.html', {
        'form': form
    })