$(document).ready(function(){
    ...
    function printResult()
    {
        ...
        if(currentUser==data[0].owner)
        {
            ...
            for(var key in data)
            {
                $("#contents").append('<h1><b>'+data[key].itemname+'</h1> <div>Description:'+data[key].description+"</div><div>Initial bid : <span id='initialbid'>"+data[key].initialbid+'</span></div><div>'+data[key].createddate+"</div><div><h2>Current Bid : <span id='bidVal' >"+data[key].bid+'</span></h2></div>');
        ...
        else
        {
            ...
            for(var key in data)
            {
                ...
                $("#contents").append('<h1><b>'+data[key].itemname+'</b></h1> <div>Description:'+data[key].description+"</div><div>Initial bid :<span id='initialbid'>"+data[key].initialbid+'</div><div> Created date :'+data[key].createddate+"</div><div><h2>Current Bid : <span id='bidVal'>"+data[key].bid+'</span></h2></div>');
